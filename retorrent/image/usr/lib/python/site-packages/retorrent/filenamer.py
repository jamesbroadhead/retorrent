...
class filenamer:
	...
	# TODO: lets not worry about nested braces for the moment
	# ( TODO: Need to handle episode numbers in braces // DEPRECATED - we don't drop all braced info any more )
	# TODO: This is a horrible mess, for something that's quite simple
	# TODO-2011: Re-write from scratch. 
	# remove braces from anything that isn't a checksum
